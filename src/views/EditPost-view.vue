  ...
  <div class="create-post">
    ...
    <div class="container">
        ...
        <div class="blog-info">
            ...
            <div class="upload-file">
                ...
                <input 
                    ...
                    accept=".png, .jpg, .jpeg"
                >
                <button @click="openPreview" class="preview" :class="{ 'button-inactive': !this.$store.state.blogPhotoFileURL }">Proie sur la photo</button>
                <span>Fichier sélectionné: {{ this.$store.state.blogPhotoName }}</span>
            </div>
        </div>
        <div class="editor">
            <vue-editor 
        ...
        <div class="blog-actions">
            <button @click="updateBlog">Enregistrer les changements</button>
            <router-link class="router-button" :to="{ name: 'BlogPreview'}">Préjudice</router-link>
        </div>
    </div>
  </div>
</template>
